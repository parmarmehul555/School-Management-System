...
class DashboardScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: FutureBuilder(future: SchoolVisitDB().copyPasteAssetFileToRoot(), builder: (context, snapshot) {
        if(snapshot.hasData){
         return Stack(
           children: [
             ClipPath(
                     ...
                     child: GridView.count(
                       ...
                       children: [
                         ...
                         GestureDetector(
                           onTap: () =>
                               Navigator.of(context).push(MaterialPageRoute(
                                 builder: (context) => Seminar_Conduct(),
                               )),
                           child: DashboardTile(
                         ...
                         GestureDetector(
                           onTap: () =>
                               Navigator.of(context).push(MaterialPageRoute(
                                 builder: (context) => Pending_Remuneration(),
                               )),
                           child: DashboardTile(
                         ...
                         GestureDetector(
                           onTap: () =>
                               Navigator.of(context).push(MaterialPageRoute(
                                 builder: (context) => Updata_Contact(),
                               )),
                           child: DashboardTile(
